...
{
public:
	Box(glm::vec2 extents, glm::vec4 colour, glm::vec2 localX, glm::vec2 localY, glm::vec2 position, glm::vec2 velocity, float mass, float angularVelocity, float moment);
	~Box();
